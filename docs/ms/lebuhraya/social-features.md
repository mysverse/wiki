...
Memandu bersama, perolehi lebih. Convoy memberi ganjaran kepada permainan yang diselaraskan dengan pengganda XP yang bertindan.
...
- **Jarak kedekatan**: Anda mesti kekal dalam lingkungan **200 stud** daripada ahli convoy lain untuk bonus dikenakan
- **Ketua**: Menetapkan peraturan jemputan dan boleh mengeluarkan ahli

### Bagaimana bonus bertindan

Bonus convoy ditambah pada tindanan pengganda XP sedia ada anda (lihat [Ekonomi dan XP](/lebuhraya/economy#the-xp-multiplier-stack)).

| Komponen | Nilai |
|---|---|
| Bonus convoy asas | +15% |
| Setiap ahli tambahan (selepas dua) | +5% setiap seorang |
| Kawan dalam convoy | +10% |
| Ahli pasukan sama dalam convoy | +10% |
| Bonus streak (masa ber-convoy) | +2% seminit, dihadkan pada +10% |
| **Jumlah maksimum bonus convoy** | **+50%** |

Penumpang dalam kenderaan convoy mendapat separuh daripada bonus pemandu.

Convoy 6 orang yang dikonfigurasi dengan baik (kawan, pasukan sama, memandu bersama selama 5+ minit) mencapai had +50% secara konsisten.

## Sistem Kecemasan 999

Perkhidmatan kecemasan Lebuhraya didorong pemain. Mana-mana pemain boleh menghubungi 999; pemain pasukan kecemasan memberi respons.

### Menghubungi 999

1. Buka **Phone** anda (ikon bar atas).
...
Setiap insiden aktif dipaparkan pada pager responden dengan lokasi anda.

### Memberi respons (pasukan kecemasan)

Jika anda berada dalam pasukan **Bomba**, **Polis Trafik**, **Undercover Police**, atau **Kesihatan**:
...
- Sehingga **10 insiden aktif** boleh wujud pada satu masa.
- Pemanggil mempunyai tempoh menunggu untuk panggilan 999 berulang.
- Jika anda menukar pasukan semasa insiden berlangsung, tugasan anda dibatalkan.
...
| **Team Access Pass** | Memberi akses sementara kepada pasukan yang dikawal gamepass tanpa memiliki gamepass |
