...
Penuaian Palm Oil adalah sektor Agro Sumaya. Anda memotong tandan Buah dari pokok sawit, mengumpulnya di dalam baldi, dan dibayar pada penghujung syif anda. Ia tersedia dari hari pertama - tiada prasyarat, tiada had tahap, hanya datang dan mulakan.

## Bermula

1. Buka telefon anda dan ketik aplikasi **Careers**.
2. Pilih **Agricultural Sector**.
3. Pergi ke sebuah Plantation sawit (aplikasi Careers akan menunjukkan arahnya).
4. Tekan gesaan **clock in**.

Setelah anda bertugas, alat pemotong sawit dan baldi pengumpulan akan muncul di dalam beg galas anda.

## Cara penuaian berfungsi

1. Hampiri sebuah pokok sawit.
2. Gunakan alat pemotong pada tandan Buah yang masak (yang ditandakan dengan gesaan penuaian).
3. Buah akan jatuh; ambil dengan baldi anda.
4. Teruskan sehingga syif anda tamat atau anda telah membersihkan semua pokok yang tersedia.

Setiap Buah yang anda masukkan ke dalam baldi membayar kadar tetap **20 Ringgit dan 6 XP** (pemain + sektor). Pendapatan terkumpul sepanjang syif dan dibayar apabila clock-out.

## Naik taraf alat dan baldi
...
Inilah perkara penting tentang Palm Oil: **anda tidak dibayar setiap penuaian. Anda dibayar apabila anda clock out.**

Apabila anda menamatkan syif anda:

- Pendapatan terkumpul anda dimasukkan terus ke dalam **akaun bank** anda (bukan dompet anda).
- Anda mendapat **bonus tetap 50 XP** di atas XP setiap penuaian.
- Anda menerima notifikasi gaji **Palm Oil Plantation**.

Kerana semuanya dimasukkan ke bank pada penghujung syif, jika anda mati atau tidak sengaja menamatkan syif lebih awal, anda tetap menyimpan apa yang telah anda perolehi. Hanya clock in semula.
