...
- Dibawa di badan anda.
- **Dihadkan kepada 500 Ringgit**. ATM menolak pengeluaran yang akan menolak dompet anda melebihi 500, dan pemindahan antara pemain dihadkan kepada baki kosong dompet penerima.
- Apa yang anda belanjakan untuk pembelian segera (item kedai, sesetengah sewaan kenderaan).
- Boleh **dicuri** melalui pickpocketing (80-300 Ringgit pada satu masa, dalam jarak 8 stud).
- Kebanyakan ganjaran kerja (bayaran setiap tindakan Bomba/Polis/Kesihatan, memancing, tangkapan radar) dibayar terus ke dompet - jika penuh, lebihan akan digugurkan. Rancang untuk mendepositkan ke dalam bank secara berkala.

### Bank

- Selamat dalam akaun anda.
- Tidak terdedah kepada pickpocketing.
- Tempat pendapatan kerjaya (kelapa sawit, jualan carjack, penyeludupan haiwan) masuk secara lalai.
- Diperlukan untuk pembelian besar (rumah, trawler Tier 2/3, kenderaan premium).
...
- **Mengeluarkan** dari bank ke dompet anda. Tidak boleh mengeluarkan jumlah yang akan menolak dompet anda melebihi had 500 Ringgit.
- **Mendeposit** dari dompet ke bank. Tiada had.
- **Memindah** kepada pemain lain dengan **nama pengguna** mereka (bukan ID pengguna). Pemindahan ATM hanyalah **bank-ke-bank**.

## Membayar pemain lain secara peribadi (Sadaqa / Donate)

Untuk pemberian kasual, lengkapkan alat **Wallet** anda dan dekati pemain lain. Gesaan **"Sadaqa to User?"** akan muncul apabila anda berada dalam jarak **10 stud** daripada mereka (Sadaqa ialah istilah Melayu / Arab untuk pemberian amal).

- Pemindahan **dompet-ke-dompet** (bukan bank).
- Had dompet penerima sebanyak 500 SR masih dikuatkuasakan - dompet yang terlalu penuh akan menolak derma.
- Pemindahan jumlah negatif disekat dan ditandakan oleh sistem anti-tipu, jadi jangan cuba.

Gunakan Sadaqa untuk hadiah roleplay pantas, berkongsi bil, atau membantu pemain baharu. Untuk pemindahan yang lebih besar, gunakan **ATM Transfer** (bank-ke-bank mengikut nama pengguna).
...
| Kesihatan (pencapaian setiap 10 rawatan) | Bonus +150 SR |
| Polis (tangkapan, setiap bintang) | 150 / 300 / 500 / 800 / 1200 SR ke dompet |
| Polis (pencapaian setiap 5 tangkapan) | Bonus +200 SR |
...
| Penyeludupan Hornbill haram | 2,000 SR ke bank |
...
Secara kasar, dari setiap jam tertinggi hingga terendah, dengan andaian anda kekal sibuk:

1. **Tangkapan 5-bintang Polis** - 1,200 SR setiap satu. Jika penjenayah dalam talian, ini adalah emas.
2. **Penyeludupan haiwan (Hornbill)** - 2,000 SR setiap larian. Walaupun cooldown 5-min.
3. **Kebakaran Bomba** - 15 SR setiap blok + bonus pencapaian setiap 15 blok. Kumpulan anggota bomba = pantas.
4. **Carjacking** - 500-1,200 SR setiap kerja. Sekali setiap 5 min, berisiko.
...
Ini berkumpul atas bayaran setiap tindakan. Rancang sesi anda untuk mencapai pencapaian, bukan hanya berhenti secara sembarangan.
