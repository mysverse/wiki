...
Sektor ialah kategori pekerjaan. Setiap sektor mempunyai:

- Satu **nama** (contohnya "Sektor Memancing", "Sektor Pertanian").
- Satu **tahap maksimum**, yang anda kumpul dengan memperoleh XP.
- Satu **tangga pangkat** - apabila tahap sektor anda meningkat, gelaran dalam permainan anda akan berubah.
- Kemungkinan **kandungan terhad tahap** - kenderaan atau alat yang hanya terbuka pada tahap sektor tertentu.
...
2. Pilih satu sektor. Jika ia terkunci, aplikasi akan memberitahu anda sebabnya.
3. Berjalan ke **stesen kerjaya** yang sepadan di dunia (jeti memancing, gerai mamak, ladang sawit). Aplikasi Careers dan pancaran panduan misi akan menunjukkan arah kepada anda.
4. Tekan arahan **interact** untuk mendaftar masuk.

Sebaik sahaja anda mendaftar masuk:

- Satu HUD khusus sektor akan muncul.
- Alat yang berkaitan akan muncul dalam beg galas anda (joran memancing, cangkuk sawit, dan sebagainya).
- Anda mula memperoleh XP dan Ringgit untuk tindakan yang anda selesaikan.

Untuk gig jobs, gunakan prompt atau antara muka gig/kerjaya apabila tersedia, kemudian ikut kad tugasan dan minimap. Larian gig mungkin membuka panel interaksi kecil untuk kertas kerja manifest, pilihan laluan, semakan urutan, atau semakan masa.

## Mendaftar keluar

Buka aplikasi Careers dan ketik kerja aktif untuk berhenti. Sesetengah sektor (seperti palm oil) hanya membayar pendapatan anda **apabila anda mendaftar keluar**, jadi jangan lupa untuk menamatkan syif anda.

Anda juga akan berhenti secara automatik jika:

- Watak anda respawn (sebarang kematian akan menamatkan syif).
- Anda menukar pasukan.

## XP dan ganjaran awam, secara ringkas
