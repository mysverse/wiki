...
捕鱼是 Sumaya 三个主要平民职业领域之一。你可以用两种方式捕鱼:在码头用**鱼竿**(快速、休闲),或在水上用**拖网渔船**(大规模、职业级的磨练)。这两个系统的报酬不同,升级的内容也不同。
...
有些码头有传送垫，可以在陆地和钓鱼浮桥之间抄近路。使用 **Travel to Fishing Pontoon** 提示前往浮桥，并使用 **Travel to Land** 提示返回。
