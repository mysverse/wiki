...
游戏内的**平板电脑**是一台多应用设备,为你的队伍提供额外功能。应用会根据你的队伍颜色来解锁 —— PDRM 警员看到 MDT,拖车员看到 MyTow,如此类推。
...
仅限 PDRM;其他队伍只会看到灰掉的标签。

### MyEmergency

紧急服务协调应用 —— 供紧急队伍(PDRM、BOMBA、KKM、SJAM)使用。管理事故来电,协调多队伍响应。
...
- **应用专属通知** —— 在特定应用的情境内(例如:计程车司机的新订单、PDRM 的 MDT 警报)。
...
- **车牌查询对任何人都有效** —— 你无需是 PDRM 也能查询车牌。

## 另请参阅

- [紧急服务](/bandaraya/emergency-services) —— 使用平板的 PDRM / BOMBA / KKM 角色
