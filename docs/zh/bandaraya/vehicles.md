...
Bandaraya 拥有 200 多辆车,涵盖 25 多个组织 - POLIS 多用途车和装甲车、消防车、军用装甲、直升机、巴士、摩托车,以及由 Proton、Perodua、Toyota 等组成的民用车队。本页介绍如何上车以及如何保养车辆。
...
1. 走到车辆生成器旁(POLIS 生成器位于 IPD Dang Wangi 外、BOMBA 生成器位于消防局、MyTransit 位于车站、Classic Car Dealer 供平民租用/购买等)。
2. 按 **E**(或接近按钮)。
...
- **AV4** - POLIS 装甲车(舱内有 29 块装甲板)。真正防弹。
- **V150** - POLIS 装甲车。
- **UTK Hilux 变体** - 舱周防弹。
